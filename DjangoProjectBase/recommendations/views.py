...
_ = load_dotenv('/Users/alejandrocarmona/Downloads/moviereviews3/api_keys.env')
client = OpenAI(api_key=os.environ.get('openai_api_key'),)

with open('/Users/alejandrocarmona/Downloads/moviereviews3/movie_descriptions_embeddings.json', 'r') as file:
